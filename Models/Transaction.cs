...
namespace sipetok_api.Models
{
    public class Transaction : BaseEntity
    {
        ...
        public Transaction(int Id, double PaymentAmount, PaymentState PaymentStatus, OrderState OrderStatus, double TotalPrice, string CustomerName, string CustomerPhoneNumber)
        {
            this.Id = Id;
