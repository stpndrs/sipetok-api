...
{
    public class EggFactory : ModuleFactory
    {
        private readonly AppDbContext _dbContext;
        private readonly IMapper _mapper;

        public EggFactory(AppDbContext dbContext, IMapper mapper)
        {
        ...
        public IMethod CreateMethod(string actionType)
        {
            switch (actionType.ToLower())
            {
                ...
                default:
                    throw new ArgumentException($"Aksi '{actionType}' tidak dikenal di EggFactory.");
            }
        }
    }
}